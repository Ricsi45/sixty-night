console.info("Sixty Night CMS V6.7.5 képes jegy modul betöltve");
...
import { firebaseConfig, ADMIN_EMAIL } from "./firebase-config.js?v=6.7.5";
import { LEGACY_CONTENT } from "./legacy-content.js?v=6.7.5";
