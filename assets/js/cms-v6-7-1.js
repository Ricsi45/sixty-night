console.info("Sixty Night CMS V6.7.1 betöltve");
...
import { firebaseConfig, ADMIN_EMAIL } from "./firebase-config.js?v=6.7.1";
import { LEGACY_CONTENT } from "./legacy-content.js?v=6.7.1";
